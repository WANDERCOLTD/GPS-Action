...
**Purpose:** The paths by which content from outside GPS Action gets *into* GPS
...
the composer offers: *"Post this URL from your clipboard? [bbc.co.uk/...]"* —
...
5. Composer shows: *"Post this URL from your clipboard? [bbc.co.uk/...]"*
...
Users install it via a one-time setup page: *"Drag this button to your
bookmarks bar. Then tap it whenever you want to share a page to GPS Action."*
...
2. **Clipboard permission priming on iOS.** First time the composer is opened,
   a single info card: *"When you copy a link, we'll offer to post it here.
   Your clipboard stays private unless you choose to use what's in it."*
...
the prompt: *"Only share URLs you mean to share publicly."* — but don't
