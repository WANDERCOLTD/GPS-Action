...
| Network message — list prefix | `radio-tower`             | `SearchHitRows` (`SearchNetworkHitRow` — search results pointing to a network-feed message; bu-search-network-and-scope-prefs Phase 1 re-use)    |
